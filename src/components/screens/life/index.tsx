        ...
        <div className={css.content}>
            ...
            <div className={css.points}>
              <div className={css.points_inner}>
                <div className={css.point}>
                  <div className={cn(css.point_content, css.point_content_l, css.point_content_l_1)}>
                    <div className={css.point_title_l}>Социум</div>
                    <div className={css.point_text_l}>
                ...
                <div className={css.point}>
                  <div className={cn(css.point_content, css.point_content_l, css.point_content_l_2)}>
                ...
                <div className={css.point}>
                  <div className={cn(css.point_content, css.point_content_l, css.point_content_l_3)}>
          ...
          <div className={css.right}>
            ...
            <div className={css.points}>
              <div className={css.points_inner}>
                <div className={css.point}>
                  <div className={cn(css.point_content, css.point_content_r, css.point_content_r_1)}>
                    <div className={css.point_title_r}>Природа</div>
                    <div className={css.point_text_r}>
                      Продолжительность жизни крысок составляет 2 - 3 года. Это заложено их природой.
                    </div>
                  </div>
                </div>
                <div className={css.point}>
                  <div className={cn(css.point_content, css.point_content_r, css.point_content_r_2)}>
                ...
                <div className={css.point}>
                  <div className={cn(css.point_content, css.point_content_r, css.point_content_r_3)}>
